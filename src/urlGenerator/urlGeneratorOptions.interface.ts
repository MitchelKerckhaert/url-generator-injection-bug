...
export interface UrlGeneratorAsyncModuleOptions extends Pick<ModuleMetadata, 'imports'> {
  inject?: any[]
  useClass?: Type<UrlGeneratorModuleOptionsFactory>
  useExisting?: Type<UrlGeneratorModuleOptionsFactory>
  useFactory?: (...args: any[]) => Promise<UrlGeneratorModuleOptions> | UrlGeneratorModuleOptions
}
...
export const URL_GENERATOR_MODULE_OPTIONS = 'URL_GENERATOR_MODULE_OPTIONS'
